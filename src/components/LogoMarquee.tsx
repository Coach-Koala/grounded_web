...
const LOGOS = [
  ...
  { file: "Rosen_Hotels.webp", name: "Rosen Hotels & Resorts" },
  { file: "Harley-Davidson.svg", name: "Harley-Davidson" },
  { file: "Langdale_Industries.webp", name: "Langdale Industries" },
  { file: "Blackstone.svg", name: "Blackstone" },
  { file: "DeSoto_Memorial_Hospital.webp", name: "DeSoto Memorial Hospital" },
  { file: "Health_Transformation_Alliance.svg", name: "Health Transformation Alliance" },
  { file: "Matheny_Motors.webp", name: "Matheny Motors" },
  { file: "PBGH.svg", name: "Purchaser Business Group on Health" },
  { file: "Pacific_Steel_and_Recycling.webp", name: "Pacific Steel & Recycling" },
  { file: "Gasparilla_Inn.svg", name: "Gasparilla Inn & Club" },
  { file: "L_and_F_Distributors.webp", name: "L&F Distributors" },
  { file: "Enovation_Controls.svg", name: "Enovation Controls" },
  { file: "Wada_Farms.webp", name: "Wada Farms" },
  { file: "Keystone_Technologies.svg", name: "Keystone Technologies" },
  { file: "RE_West_Transportation.webp", name: "R.E. West Transportation" },
  { file: "Horizon_Goodwill.svg", name: "Horizon Goodwill Industries" },
  { file: "Copper_State_Bolt_and_Nut.webp", name: "Copper State Bolt & Nut" },
  { file: "Palmer_Johnson_Power_Systems.svg", name: "Palmer Johnson Power Systems" },
  { file: "Pipe_Trades_Services_MN.webp", name: "Pipe Trades Services MN" },
  { file: "Woodard_Cleaning_and_Restoration.svg", name: "Woodard Cleaning & Restoration" },
  { file: "Kenny_Pipe_and_Supply.webp", name: "Kenny Pipe & Supply" },
  { file: "Paul_B_Zimmerman.webp", name: "Paul B. Zimmerman" },
  { file: "Ashtabula_Area_City_Schools.webp", name: "Ashtabula Area City Schools" },
] as const;
